...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, frame hidden, breakable, interior hidden, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, enhanced]}{\end{tcolorbox}}\fi
...
\NormalTok{vec1 }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(LETTERS,}\DecValTok{5}\NormalTok{)}
\FunctionTok{paste0}\NormalTok{(vec1,}\AttributeTok{collapse=}\StringTok{""}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
